<template>
  <v-dialog v-model="dialog" @click:outside="hideDialog()">
    <v-row justify="center" v-if="!registered">
      <v-card color="#333345" dark max-width="90vw" max-height="80vh">
        <p style="padding:20px;text-align:center">
          <b>IMPORTANTE:</b>La información que vas a suministrar es
          completamente voluntaria y no será tratada.
        </p>
        <v-col>
